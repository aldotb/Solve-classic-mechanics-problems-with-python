...
w,w1,w2,aw,aw1,aw2,F,F1,F2,Rx,Ry,r,r1,r2,R,ax, ax2,ay,ay1,ay2= symbols('w w1 w2 a_w aw1 aw2 F F1 F2 Rx Ry r r1 r2 R  ax1 ax2 ay ay1 ay2')
...
class mparticle:
    def __init__(self,x1=x1,x2=x2,y1=y1,y2=y2,v1=v1,v2=v2,m=m,a=0,ang=0,g=g,v=v,w=w,ac=0,s='r',t=t,r=r,r1=r1,r2=r2,vx='',vy='',vxy=vxy,Ti=Ti,Io=Io,aw=aw,w1=w1,w2=w2 ,at=at,ax=ax,ay=ay,typeI='',mu=mu, Nm=Nm,Itype='p',xI=0,dire=0,direx=0,direy=0,vv='',deltat=0.01,posx=0,posy=0,dt=dt,Ma=Ma,type='P',q=q,K=K):
